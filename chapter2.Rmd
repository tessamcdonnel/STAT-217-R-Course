...
test_data_frame("arbuthnot", columns = "my_var", incorrect_msg = "Follow the format in the lesson with `arbuthnot` instead of 'dataset', `my_var` instead of 'new_var', `boys` instead of 'var1', and `girls` instead of 'var2'.")
