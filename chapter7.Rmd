...
The three horizontal lines show 95% confidence intervals for each difference in means. If the confidence interval contains zero, it is plausable that the population means are *equal* for that that pair. In this exercise only **one** interval does not contain zero.
...
- The population mean post-weight for patients in the FT (family treatment) group is significantly greater than the population mean post-weight for patients in the CBT (Cognitive Behavioural treatment) group.
*** =hint
