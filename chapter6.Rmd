...
At  $\alpha$ =  0.05, we would REJECT the null hypothesis and conclude that we have evidence that the population mean number of alcoholic drinks consumed per day is **greater** than 2. This makes sense because the data was taken from patients at a rehab facility. 
