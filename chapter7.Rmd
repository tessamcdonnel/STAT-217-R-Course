...
## <<<New Exercise>>>.. i'll come back to this later

The *plots* panel contains the same plot from the last exercise. 

The three horizontal lines show 95% confidence intervals for each difference in means. If the confidence interval contains zero, it is plausable that the population means are equal for that that pair. In this exercise only one interval does not contain zero, indicating that the population mean post-weight of patients in __ is significantly greater than 
