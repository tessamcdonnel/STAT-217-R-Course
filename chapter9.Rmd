...
Using the command `cor(x = gun_violence_us$ownership_rate, y = gun_violence_us$mortality_rate)` will produce the same results as the command `cor(x = gun_violence_us$mortality_rate, y = gun_violence_us$ownership_rate)`.
