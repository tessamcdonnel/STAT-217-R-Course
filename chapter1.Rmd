...
test_output_contains("(0.6-0.5) / sqrt(0.25/1000)", incorrect_msg = "That is incorrect. Type (0.6-0.5) / sqrt(0.25/1000) to evaluate the expression.")
...
test_output_contains("my_object", incorrect_msg = "Remember to type 'my_object' to print out the contents of my_object") 
