...
The sex variable represents a _______ variable in reality; in R, this variable should be defined as a ______ variable.
*** =instructions
...
* Next, to use the `favstats()` function, use the format: `favstats(dataset$quant_var)`.
