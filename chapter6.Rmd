...
`HELPrct` contains a variable called `i1` which reports the average number of alcoholic drinks consumed ***per day*** (within the last month). 

If you want more information about this data set type: `?HELPrct` into the R console.
*** =instructions
- Type `HELPrct$i1` in your script to view the average number of alcoholic drinks the patients consumed per day before coming to the detox facility.
...
--- type:MultipleChoiceExercise lang:r xp:50 skills:1 key:0130fafe7f
## <<<New Exercise>>>

	One Sample t-test

data:  HELPrct$i1
t = 3.0908, df = 452, p-value = 0.00106
...
*** =pre_exercise_code
```{r}
results <- t.test(x = HELPrct$i1, mu = 15, alternative = "greater", conf.level = 0.99)
