...
Suppose that in *my* sample, the sample mean chick weight was 125.65.

How does this compare to the **population mean**?

The population `favstats()` results are stored in an object called `pop_results`; in your R console type `pop_results` to view.


*** =instructions
- The sample mean is less than the population mean.
- The sample mean is equal to the population mean.
- The sample proportion is greater than the population mean.
...
msg_success <- "Exactly!"
test_mc(correct = 4, feedback_msgs = c(msg_bad, msg_bad, msg_bad, msg_bad, msg_success))
...
*** =sct
```{r}
msg_bad <- "That is not correct. The summary() function does NOT give you the standard deviation."
msg_success <- "Exactly!"
