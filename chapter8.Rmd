...
test_mc(correct = 2, feedback_msgs = c(msg_bad, msg_bad, msg_success, msg_bad))
...
msg_success <- "Exactly. The proportions are different but let's see if the difference is statistically significant!"
...
## Quick check 4
**This is the last exercise of Lab 7 practice course**
